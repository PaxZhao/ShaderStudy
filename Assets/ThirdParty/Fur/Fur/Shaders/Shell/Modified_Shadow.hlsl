#ifndef FUR_SHELL_MOD_SHADOW_HLSL
#define FUR_SHELL_MOD_SHADOW_HLSL
    ...
    out float outDepth : SV_Depth)
{
    ...
    // Used input.uv without scaling it
    float4 furMask = SAMPLE_TEXTURE2D(_FurMask, sampler_FurMask, input.uv);
